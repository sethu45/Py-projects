list_words = '''abruptly absurd abyss affix askew avenue awkward axiom azure 
...
giaourgizmo glowworm glyph gnarly gnostic gossip grogginess haiku 
...
zigzag zigzagging zilch zipper zodiac zombie'''.split()
